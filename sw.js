...
const CACHE_NAME = 'nailsbyheyllen-v49';
const urlsToCache = [
  '/nailsbyheyllen/',
  '/nailsbyheyllen/index.html',
  '/nailsbyheyllen/admin.html',
  '/nailsbyheyllen/admin-login.html',
  '/nailsbyheyllen/calendar.html',
  '/nailsbyheyllen/setup-wizard.html',
  '/nailsbyheyllen/editar-negocio.html',
  '/nailsbyheyllen/manifest.json',
  '/nailsbyheyllen/icons/icon-72x72.png',
  '/nailsbyheyllen/icons/icon-96x96.png',
  '/nailsbyheyllen/icons/icon-128x128.png',
  '/nailsbyheyllen/icons/icon-144x144.png',
  ...
  '/nailsbyheyllen/utils/push-config.js',
  '/nailsbyheyllen/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/nailsbyheyllen/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/nailsbyheyllen/icons/icon-192x192.png',
    badge: '/nailsbyheyllen/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/nailsbyheyllen/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/nailsbyheyllen/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Nails by Heyllem');
